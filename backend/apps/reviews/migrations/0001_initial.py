...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="""
            -- Fix reviews_review table
            ALTER TABLE reviews_review ALTER COLUMN id SET DEFAULT gen_random_uuid();
            ALTER TABLE reviews_review ALTER COLUMN created_at SET DEFAULT NOW();
            ALTER TABLE reviews_review ALTER COLUMN updated_at SET DEFAULT NOW();
            """,
            reverse_sql="""
            ALTER TABLE reviews_review ALTER COLUMN id DROP DEFAULT;
            ALTER TABLE reviews_review ALTER COLUMN created_at DROP DEFAULT;
            ALTER TABLE reviews_review ALTER COLUMN updated_at DROP DEFAULT;
            """,
        ),
    ]
