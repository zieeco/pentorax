...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="""
            -- Fix support_supportticket table
            ALTER TABLE support_supportticket ALTER COLUMN id SET DEFAULT gen_random_uuid();
            ALTER TABLE support_supportticket ALTER COLUMN created_at SET DEFAULT NOW();
            ALTER TABLE support_supportticket ALTER COLUMN updated_at SET DEFAULT NOW();
            """,
            reverse_sql="""
            ALTER TABLE support_supportticket ALTER COLUMN id DROP DEFAULT;
            ALTER TABLE support_supportticket ALTER COLUMN created_at DROP DEFAULT;
            ALTER TABLE support_supportticket ALTER COLUMN updated_at DROP DEFAULT;
            """,
        ),
    ]
