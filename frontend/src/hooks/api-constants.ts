/**
 * API Configuration Constants for Next.js 16.
 * Refactored from legacy api.constants.ts.
 * Centralized configuration for React Query and data fetching.
 */
...
export const QUERY_KEYS = {
  products: {
    ...
    paginated: (params: Record<string, any>) =>
      [...QUERY_KEYS.products.all, 'paginated', params] as const,
    ...
    related: (productId: string, categoryId: string) =>
      [...QUERY_KEYS.products.all, 'related', productId, categoryId] as const,
  },
  categories: {
