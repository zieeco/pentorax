...
export function SignupLeftPane() {
  return (
    <div className="bg-muted/30 relative hidden flex-col overflow-hidden lg:flex lg:w-[50%]">
      <div className="p-6">
        <AuthLogo />
      </div>
      <div className="flex flex-1 flex-col items-center justify-center px-12">
        <div className="relative mb-8 w-full max-w-md">
          ...
          <Image
            ...
            width={1000}
            height={320}
            className="border-background h-[320px] w-full rotate-2 rounded-[2.5rem] border-4 object-cover shadow-2xl transition-transform duration-700 hover:rotate-0"
          />
        </div>
        <div className="max-w-lg text-center">
          <h2 className="text-foreground mb-4 text-[2.6rem] leading-[1.1] font-black">
            Power your home, <br />
