...
const CareersPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Careers at PentoraX | Join Our Team"
        description="Join PentoraX and help democratize renewable energy across Africa. We're hiring solar engineers, developers, and operations managers. Work that matters."
        keywords="pentorax careers, solar jobs Nigeria, renewable energy jobs, engineering jobs Africa, remote developer jobs"
        ogImage="/careers-team.png"
      />
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
              <button 
                ...
                type="button" 
                className="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded-xl font-bold shadow-xl shadow-primary/20 hover:bg-blue-700 transition-colors"
              >
                View Openings
              </button>
              <a 
                href="/about" 
                className="w-full sm:w-auto bg-white border-2 border-gray-100 text-gray-900 px-8 py-4 rounded-xl font-bold hover:bg-gray-50 transition-colors text-center"
              >
                Our Culture
              </a>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              {jobs.map((job, i) => (
                <div key={i} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between hover:shadow-md transition-all group">
                  ...
                  <a 
                    href="/contact" 
                    className="flex items-center text-primary font-bold group-hover:underline"
                  >
