...
const AccessoriesPage: React.FC = () => {
  // TODO: Replace with API call - useQuery('accessories', fetchAccessories)
  const products = [
    {
      id: 1,
