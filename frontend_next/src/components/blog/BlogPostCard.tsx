...
export function BlogPostCard({ post }: BlogPostCardProps) {
  ...
  return (
    <Link href={`/blog/${post.slug}`} className="group flex h-full flex-col">
      <Card className="flex h-full flex-col overflow-hidden rounded-[2.5rem] border-gray-100 bg-white shadow-sm transition-all duration-700 group-hover:-translate-y-2 hover:shadow-2xl">
        ...
        <div className="flex flex-grow flex-col p-8">
          <div className="mb-6 flex items-center gap-4">
            ...
            <span className="flex items-center gap-2 text-[10px] font-black tracking-widest text-gray-400 uppercase italic">
