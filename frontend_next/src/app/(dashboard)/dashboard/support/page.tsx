...
export default function SupportPage() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 space-y-8 duration-700">
      ...
      {/* Search Bar Big */}
      <Card className="shadow-primary/5 bg-primary relative overflow-hidden rounded-[2.5rem] border-none p-12 shadow-xl">
        <div className="relative z-10 mx-auto max-w-2xl text-center">
          ...
          <div className="group relative">
            ...
            <Input
              ...
              className="rounded-2xl border-transparent bg-white py-8 pr-6 pl-14 text-lg font-bold shadow-2xl shadow-black/10 focus:ring-4 focus:ring-white/20"
            />
          </div>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        {[
          ...
          <Card
            key={i}
            className="group rounded-[2rem] border-gray-100 bg-white p-8 shadow-sm transition-all hover:shadow-md"
          >
            <div className="group-hover:bg-primary/5 mb-6 w-fit rounded-2xl bg-gray-50 p-4 transition-colors">
              <item.icon className="text-primary h-6 w-6" />
            </div>
            <h3 className="mb-2 text-xl font-black text-gray-900">{item.title}</h3>
            <p className="mb-6 text-sm leading-relaxed font-medium text-gray-500">{item.desc}</p>
            <Button
              variant="ghost"
      ...
      <Card className="border-brand-green/20 bg-brand-green/[0.03] rounded-[2rem] border p-8">
        <div className="flex items-center gap-6">
          <div className="bg-brand-green/10 rounded-2xl p-4">
            <ShieldCheck className="text-brand-green h-6 w-6" />
          </div>
          <div>
            <h4 className="text-brand-green text-lg font-black">99.9% Uptime SLA reached</h4>
            <p className="text-brand-green/70 text-sm font-bold">
          ...
          <Button
            variant="outline"
            className="border-brand-green/20 text-brand-green ml-auto gap-2 rounded-xl bg-white font-bold"
          >
