    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          yellow: '#F9C74F', // Secondary Yellow
          green: '#43AA8B', // Supporting Green
          indigo: '#4361EE', // Supporting Indigo
          dark: '#2D2D2D', // Neutral Dark
          light: '#F5F5F5', // Neutral Light
          white: '#FFFFFF', // Neutral White
        },

        // Existing system colors (CSS variables driven)
