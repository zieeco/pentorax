        ...
        <div className="flex w-full flex-col items-center lg:flex-row">
          ...
          >
            ...
            <div className="mt-8">
              ...
              >
                <span className="relative z-10">Get Quote + Pricing Now</span>
          ...
          <div
            className={`mt-12 flex transform justify-center transition-all delay-300 duration-1000 lg:mt-0 lg:w-1/2 lg:justify-end ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}
          >
            <div className="group relative">
              ...
              <div className="absolute inset-0 flex items-end justify-center rounded-lg bg-gradient-to-t from-blue-900/50 to-transparent p-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">$0</div>
                  <div className="text-sm text-cyan-300">Down Payment</div>
                </div>
              </div>
            </div>
          </div>
