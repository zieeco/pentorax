...
const ProcessStep: React.FC<ProcessStepProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative flex-1 overflow-hidden rounded-xl shadow-lg transition-all duration-500 ${
          ...
          <div className="mb-4 flex items-center justify-between">
            <div
              className={`rounded-full p-3 transition-all duration-300 ${
                isHovered
                  ? 'scale-110 bg-white/20 shadow-sm backdrop-blur-sm'
...
const ArnegyProcessSection: React.FC = () => {
  ...
  const backgroundImages = [
    'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1973&q=80', // Consultation - modern home
    'https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80', // Design - blueprints/planning
    'https://images.unsplash.com/photo-1509391366360-2e959784a276?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80', // Installation - workers installing
    'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80', // Support - customer service/monitoring
  ];
...
export default ArnegyProcessSection;
